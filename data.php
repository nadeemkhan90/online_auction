...
if ($row['post']=="seller")
 print "<ul>
<li><a href = \"register.php\"> <img src='images/pro.png'></li><br/>
...
{
print "</br><a href= \"search.php\"><img src='images/BIDDING.png'></a> ";
print " <br></br><a href= \"account.php\"><img src='images/account.png'></a> ";
